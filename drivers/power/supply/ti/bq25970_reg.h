...
#define SC8551_ADC_LSB_DENOM				10000000
#define SC8551_IBUS_ADC_LSB_NUM				15625000
#define SC8551_VBUS_ADC_LSB_NUM				37500000
#define SC8551_VAC_ADC_LSB_NUM				50000000
#define SC8551_VOUT_ADC_LSB_NUM				12500000
#define SC8551_VBAT_ADC_LSB_NUM				12575000
#define SC8551_IBAT_ADC_LSB_NUM				31250000
#define SC8551_TSBUS_ADC_LSB_NUM			9766
#define SC8551_TSBAT_ADC_LSB_NUM			9766
#define SC8551_TDIE_ADC_LSB_NUM				5000000
